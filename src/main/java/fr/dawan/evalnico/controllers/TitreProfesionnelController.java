...
public class TitreProfesionnelController {
	...
	public ResponseEntity<TitreProfessionnelDto> save(@RequestBody TitreProfessionnelDto titreProDto) throws Exception {
	...
	public ResponseEntity<TitreProfessionnelDto> update(@RequestBody TitreProfessionnelDto titreProDto) throws Exception {
		TitreProfessionnelDto result = null;
	...
	public ResponseEntity<List<TitreProfessionnelDto>> findByTitre(
			@PathVariable(name = "titre", required = true) String titre) {
